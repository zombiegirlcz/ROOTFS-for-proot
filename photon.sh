#!/bin/bash
# Distribution plug-in for VMware Photon OS 5.0
# Auto-generated on 2026-09-19T04:45:00Z

DISTRO_NAME="VMware Photon OS 5.0"
DISTRO_COMMENT="VMware Photon OS official cloud-native container rootfs (tdnf)"
DISTRO_ICON="💡"

declare -A TARBALL_URL
declare -A TARBALL_SHA256

TARBALL_URL['x86_64']="https://raw.githubusercontent.com/vmware/photon-docker-image/6d92cd0c93bcfbdb3fe09a72bdc6657f646fd012/docker/photon-rootfs-5.0-deb740b97.x86_64.tar.gz"
TARBALL_SHA256['x86_64']="ddcb7a4bfc1cbb2949a7a3c8955339cccb5f111ea400ad1085b197b4f1359ea0"

TARBALL_URL['aarch64']="https://raw.githubusercontent.com/vmware/photon-docker-image/d14d4084e8f8384ebc0ac015b8533c0a5bfd2167/docker/photon-rootfs-5.0-deb740b97.aarch64.tar.gz"
TARBALL_SHA256['aarch64']="af2972689c78c4696f9581b0e8ebbd8053bb58cdff0d3db69b0976fd36e32edd"
...
#!/bin/sh
# Entrypoint for VMware Photon OS in PRoot
