#!/bin/bash
# Distribution plug-in for NixOS
# Auto-generated on 2026-09-18T21:40:00Z

DISTRO_NAME="NixOS"
DISTRO_COMMENT="NixOS binary distribution with Nix package manager"
DISTRO_ICON="❄️"
